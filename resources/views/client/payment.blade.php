        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12 pay-wrap">
                ...
                <div class="form-group d-flex">
                    <input class="w-50 mr-4 py-2 px-3" type="text" name="lastname" placeholder="Tên">
                ...
                <div class="form-group">
                  <textarea class="form-control pay-text p-3" name="" id="" rows="5" placeholder="Ghi chú về đơn hàng, vd: thời gian hay địa chỉ cụ thể"></textarea>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-12">
                <div class="pay-detail my-5 py-4 px-5">
                    ...
                    <div class="pay-discount">
                        ...
                        <div class="form-group">
                            <input class="pay-text w-50 py-2 px-3" type="text" name="discount" value="" placeholder="Nhập mã giảm giá">
                        </div>
                    </div>
                    <div class="pay-total d-flex justify-content-between font-weight-bold my-3">
                        <p>Tổng thanh toán</p>
                        <p class="pink-color">{{ number_format($total) }} đ</p>
                    </div>
                    <div class="pay-bank">
                        <input type="radio" id="bank" checked name="payment" value="bank">
                        <label for="bank">Chuyển khoản ngân hàng</label><br>
                        <p class="pink-color" id="pay-rule">Thực hiện thanh toán vào ngay tài khoản ngân hàng của chúng tôi. Vui lòng sử dụng Mã đơn hàng của bạn trong phần Nội dung thanh toán. Đơn hàng sẽ đươc giao sau khi tiền đã chuyển.</p>
                    </div>
                    ...
                    <a href="" class="btn pay-btn px-4 py-1 my-3">Đặt hàng</a>

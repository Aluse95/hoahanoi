      ...
      <div class="form-login m-auto ">
        ...
        <form action="" method="post">
          ...
          <div class="form-group mb-5">
            ...
            <input type="text" name="password" value="" class="form-control input-login" placeholder="Nhập mật khẩu..." aria-describedby="helpId">
            @error('password')
              <p class="red">{{ $message }}</p>
            @enderror
          </div>
          <button type="submit" class="btn-login btn btn-primary pb-2">Đăng kí</button>
          <a href="login" class="btn-login ml-2">Quay lại trang đăng nhập</a>    
        </form>
      </div>
    </div>  
